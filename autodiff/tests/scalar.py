...
class TestAutodiff(unittest.TestCase):
    ...
    def test_value(self):
        ...
        with autodiff.assign(x1=1):
            self.assertAlmostEqual(autodiff.value(x), 1)

    def test_const_addition_value(self):
        x = autodiff.Variable('x2')
        s = x + 3
        with autodiff.assign(x2=1):
            self.assertAlmostEqual(autodiff.value(s), 4)
    ...
    def test_const_addition_deriv(self):
        ...
        with autodiff.assign(x3=1):
            self.assertAlmostEqual(autodiff.value(dsdx), 1)
    ...
    def test_addition_value(self):
        ...
        with autodiff.assign(x4=1, y1=2):
            self.assertAlmostEqual(autodiff.value(s), 3)
    ...
    def test_constant_mult_deriv(self):
        ...
        with autodiff.assign(x8=3):
            self.assertAlmostEqual(autodiff.value(dydx), 2)
    ...
    def test_mult_value(self):
        ...
        with autodiff.assign(x9=3, y3=4):
            self.assertAlmostEqual(autodiff.value(z), 12)
    ...
    def test_mult_deriv(self):
        ...
        with autodiff.assign(x10=3, y4=4):
            self.assertAlmostEqual(autodiff.value(dzdx), 4)
            self.assertAlmostEqual(autodiff.value(dzdy), 3)

    def test_power_value(self):
        x = autodiff.Variable('x11')
        sq = x**2
        with autodiff.assign(x11=4):
            self.assertAlmostEqual(autodiff.value(sq), 16)
    ...
    def test_power_deriv(self):
        ...
        with autodiff.assign(x12=4):
            self.assertAlmostEqual(autodiff.value(dsqdx), 8)
    ...
    def test_linear_combo(self):
        ...
        with autodiff.assign(x13=5, m1=3, b1=2):
            self.assertAlmostEqual(autodiff.value(lin), 17)
            self.assertAlmostEqual(autodiff.value(dlindx), 3)
            self.assertAlmostEqual(autodiff.value(dlindm), 5)
            self.assertAlmostEqual(autodiff.value(dlindb), 1)
    ...
    def test_dist_formula(self):
        ...
        with autodiff.assign(x14=3, y5=4):
            self.assertAlmostEqual(autodiff.value(z), 5)
            self.assertAlmostEqual(autodiff.value(dzdx), 3/5)
            self.assertAlmostEqual(autodiff.value(dzdy), 4/5)
    ...
    def test_mult_assignments(self):
        ...
        with autodiff.assign(x15=3, y6=4):
            self.assertAlmostEqual(autodiff.value(z), 7)
        with autodiff.assign(x15=5, y6=3):
            self.assertAlmostEqual(autodiff.value(z), 8)
    ...
    def test_compound_exp_unassigned_error(self):
        x = autodiff.Variable('x18')
        y = autodiff.Variable('y9')
        z = autodiff.Variable('z1')
        w = z * (x + y)
        with self.assertRaises(autodiff.VariableAssignmentError):
            autodiff.value(w)
    ...
    def test_compound_exp_unassigned_after_assigned_error(self):
        x = autodiff.Variable('x19')
        y = autodiff.Variable('y10')
        z = autodiff.Variable('z2')
        w = z * (x + y)
        with autodiff.assign(x19=1, y10=2, z2=3):
            self.assertAlmostEqual(autodiff.value(w), 9)
        with self.assertRaises(autodiff.VariableAssignmentError):
            autodiff.value(w)
